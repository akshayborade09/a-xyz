...
export default function PlaygroundPage() {
  ...
  useEffect(() => {
    if (selectedModel !== modelId) {
      ...
      } else if (selectedModel === 'krutrim-text-to-speech') {
        // If Krutrim-Text-to-Speech is selected, redirect to its dedicated page
        router.push('/playground/krutrim-text-to-speech');
      } else if (selectedModel === 'krutrim-speech-to-speech') {
        // If Krutrim-Speech-to-Speech is selected, redirect to its dedicated page
        router.push('/playground/krutrim-speech-to-speech');
      } else if (selectedModel === 'qwen3-image') {
        // If Qwen3-Image is selected, redirect to its dedicated page
        router.push('/playground/qwen3-image');
      } else {
